          ...
          <div className="card overflow-hidden">
            ...
            <div className="bg-slate-100 p-2">
              ...
              {(previewFile.fileType ===
                ...
                previewFile.fileType ===
                  'video/quicktime') && (
                <div className="flex min-h-[600px] items-center justify-center rounded-md bg-black">
          ...
          <div className="card flex min-h-[500px] items-center justify-center p-8">
            ...
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-slate2-500">
                Select View on an attachment to preview it here.
              </p>
            </div>
